...
sed -i "s/DISTRIB_DESCRIPTION='Sakura '/DISTRIB_DESCRIPTION='Sakura '/g" ./package/lean/default-settings/files/zzz-default-settings
sed -i "s/hostname='Sakura'/hostname='Sakura'/g" ./package/base-files/files/bin/config_generate
